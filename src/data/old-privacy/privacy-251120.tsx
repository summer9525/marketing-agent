export const Privacy251120 = () => (
  <>
    <h2 className="text-heading3 mb-6">주식회사 아이지에이웍스 개인정보처리방침</h2>

    <p className="text-body2 mb-6">
      주식회사 아이지에이웍스(이하 &apos;아이지에이웍스&apos;라 함)는 「개인정보 보호법」 및 관계 법령이 정한 바를 준수하여 적법하게 개인정보를 처리하고 안전하게 관리하고 있습니다. 이에 「개인정보 보호법」 제30조에 따라 정보주체에게 개인정보 처리에 관한 절차 및 기준을 안내하고, 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
    </p>
    ...
    <ol className="list-decimal pl-5 space-y-3 text-body2">
      ...
      <li>
        ...
        <ul className="list-disc pl-5 mt-2 space-y-1">
          ...
          <li>다) 재화 또는 서비스 제공 및 민원 접수, 처리 결과 통보 등 민원 사무 처리<br/>서비스(DFINERY, MOBILEINDEX, TV INDEX)제공, 계약서 발송 및 체결, 민원인의 신원 확인, 민원사항 확인, 사실조사를 위한 연락·통지, 처리결과 통보 목적으로 개인정보를 처리합니다.</li>
          <li>라) 요금 정산 처리<br/>아이지에이웍스가 이용자에게 제공한 서비스(DFINERY, MOBILEINDEX, TV INDEX) 이용 요금을 정산하기 위한 목적으로 개인정보를 처리합니다.</li>
      ...
      <li>
        ...
        <div className="overflow-x-auto mt-2">
          <table className="w-full text-sm border-collapse border border-border">
            ...
            <tbody>
              <tr><td className="border border-border px-3 py-2">(필수) 성명, 이메일, 연락처, 회사업종</td><td className="border border-border px-3 py-2">회원 탈퇴 또는 서비스 이용계약 종료 시까지.</td></tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="overflow-x-auto mt-2">
          <table className="w-full text-sm border-collapse border border-border">
            ...
            <tbody>
              ...
              <tr><td className="border border-border px-3 py-2" rowSpan={2}>현금결제</td><td className="border border-border px-3 py-2">법인</td><td className="border border-border px-3 py-2">사업자등록증, 사업자명, 담당자명, 연락처, 회사주소, 이메일</td></tr>
              <tr><td className="border border-border px-3 py-2">개인</td><td className="border border-border px-3 py-2">사업자등록증, 사업명, 연락처, 이메일</td></tr>
            </tbody>
          </table>
        </div>
      ...
      <li>
        ...
        <div className="overflow-x-auto mt-3">
          <table className="w-full text-sm border-collapse border border-border">
            ...
            <tbody>
              <tr><td className="border border-border px-3 py-2">데이터 보관 / 전산시스템 운용, 관리</td><td className="border border-border px-3 py-2">- 업체명 : Amazon Web Service<br/>- 연락처 : aws-korea-privacy@amazon.com</td><td className="border border-border px-3 py-2" rowSpan={7}>위탁 사업 종료 또는 위탁업무 목적 달성 후 즉시 파기</td></tr>
    ...
    <ol className="list-decimal pl-5 space-y-3 text-body2">
      ...
      <li>제1항에 따른 정보주체의 권리 행사는 「개인정보 보호법」 시행규칙 별지 제8호 서식에 따라 개인정보(열람, 정정·삭제, 처리정리) 요구서를 작성한 후 서면, 전화, 전자우편, 모사전송(FAX)을 통하여 하실 수 있으며, 아이지에이웍스는 요구를 받은 날부터 빠른 시일 내에 조치하도록 하겠습니다.</li>
      ...
      <li>
        ...
        <div className="overflow-x-auto mt-3">
          <table className="w-full text-sm border-collapse border border-border">
            ...
            <tbody>
              <tr><td className="border border-border px-3 py-2">총괄 개인정보보호책임자</td><td className="border border-border px-3 py-2">기술이사</td><td className="border border-border px-3 py-2">박진우</td><td className="border border-border px-3 py-2" rowSpan={4}>privacy@igaworks.com</td></tr>
              <tr><td className="border border-border px-3 py-2">총괄 개인정보보호담당자</td><td className="border border-border px-3 py-2">보안팀</td><td className="border border-border px-3 py-2">예석환</td></tr>
              <tr><td className="border border-border px-3 py-2" rowSpan={2}>분야별 개인정보보호담당자</td><td className="border border-border px-3 py-2">MI &amp; DMP</td><td className="border border-border px-3 py-2">성석주</td></tr>
              <tr><td className="border border-border px-3 py-2">디파이너리 &amp; 애드브릭스</td><td className="border border-border px-3 py-2">이지원</td></tr>
            </tbody>
          </table>
        </div>
      </li>
    ...
    <p className="text-body2">이 개인정보 처리방침은 2025년 11월 20일부터 적용됩니다. 이 전의 개인정보 처리방침은 아래에서 확인할 수 있습니다.</p>

    <h2 className="text-heading3 mt-12 mb-4">부칙</h2>
    <p className="text-body2 mb-2">본 개인정보처리방침은 2025년 11월 20일부터 시행합니다.</p>
