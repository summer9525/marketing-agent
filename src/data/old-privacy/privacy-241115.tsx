export const Privacy241115 = () => (
  <>
    ...
    <p className="text-body2 mb-6">본 개인정보처리방침은 2024년 11월 15일부터 적용됩니다.</p>
    ...
    <ol className="list-decimal pl-5 space-y-3 text-body2">
      <li>
        ...
        <ul className="list-disc pl-5 mt-2 space-y-1">
          <li>&apos;개인정보&apos;는 「개인정보보호법」 제2조 제1호에 따라 개인정보로 인정되는 정보를 의미합니다.</li>
          ...
          <li>여기에 별도로 정의되지 아니한 용어는 「개인정보보호법」, 같은 법 시행령 및 시행규칙, 「개인정보의 안전성 확보조치 기준」 및 「표준 개인정보 보호지침」 등에 정의된 바에 따릅니다.</li>
        </ul>
      </li>
      ...
      <li>
        아이지에이웍스는 다음의 목적을 위하여 최소한의 개인정보를 수집하여 처리하며, 정보주체의 사생활을 현저히 침해할 우려가 있는 민감정보(사상, 신념, 노동조합, 정당의 가입/탈퇴, 정치적 견해, 건강, 성생활 등에 관한 정보 등)는 수집하지 않습니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며 이용 목적이 변경되는 경우에는 「개인정보보호법」 제18조에 따라 정보주체의 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.
        <ul className="list-disc pl-5 mt-2 space-y-1">
          <li>가) 회원가입 및 회원정보 관리<br/>회원 가입의사 확인, 회원제 서비스 제공에 따른 본인(법인/개인) 식별·인증, 회원자격 유지·관리, 서비스 부정이용 방지, 만14세 미만 아동의 개인정보 처리 시 법정대리인의 동의여부 확인, 각종 고지·통지, 고충처리 목적으로 개인정보를 처리합니다</li>
          <li>나) 재화 또는 서비스 제공 및 민원 접수, 처리 결과 통보 등 민원 사무 처리<br/>서비스(DFINERY, MOBILEINDEX, TRADINGWORKS, GROWTH CONSULTING, MARKETING CLOUD 등 이에 한정하지 않음)제공, 계약서 발송 및 체결, 민원인의 신원 확인, 민원사항 확인, 사실조사를 위한 연락·통지, 처리결과 통보 목적으로 개인정보를 처리합니다.</li>
          <li>다) 요금 정산 처리<br/>아이지에이웍스가 이용자에게 제공한 서비스(DFINERY, MOBILEINDEX, TRADINGWORKS, GROWTH CONSULTING, MARKETING CLOUD 등 이에 한정하지않음) 이용 요금을 정산하기 위한 목적으로 개인정보를 처리합니다.</li>
          <li>라) 서비스에의 활용<br/>아이지에이웍스는 DFINERY 솔루션을 통한 광고성과의 측정 및 분석, CRM 메시지 발송 등의 서비스를 제공하기 위한 목적으로 개인정보 및 회원사 서비스 이용자의 데이터를 처리합니다.</li>
          <li>마) 마케팅 및 광고에의 활용<br/>신규 서비스(제품) 개발 및 맞춤 서비스 제공, 이벤트 및 광고성 정보 제공 및 참여기회 제공, 인구통계학적 특성에 따른 서비스 제공 및 광고 게재, 서비스의 유효성 확인, 접속빈도 파악 또는 회원의 서비스 이용에 대한 통계, 이용자의 관심 및 성향에 기반한 개인맞춤형 상품 추천 서비스(광고 포함) 등을 목적으로 개인정보를 처리합니다.</li>
        </ul>
      </li>
    </ol>
    ...
    <ol className="list-decimal pl-5 space-y-3 text-body2">
      ...
      <li>
        ...
        <p className="font-medium mt-4 mb-2">1) 회원가입 및 회원정보 관리</p>
        <div className="overflow-x-auto mt-2">
          <table className="w-full text-sm border-collapse border border-border">
            <thead>
              <tr className="bg-muted">
                <th className="border border-border px-3 py-2 text-left">구분</th>
                <th className="border border-border px-3 py-2 text-left">수집항목</th>
                <th className="border border-border px-3 py-2 text-left">보유기간</th>
              </tr>
            </thead>
            <tbody>
              <tr><td className="border border-border px-3 py-2">디파이너리 (DFINERY)</td><td className="border border-border px-3 py-2">(필수) 성명, 이메일</td><td className="border border-border px-3 py-2" rowSpan={2}>회원탈퇴 또는 서비스 이용계약 종료 시까지</td></tr>
              <tr><td className="border border-border px-3 py-2">모바일인덱스 (MOBILEINDEX) / 트레이딩웍스 (TRADINGWORKS) / 마케팅클라우드 (MARKETING CLOUD)</td><td className="border border-border px-3 py-2">(필수) 성명, 이메일, 연락처, 회사업종</td></tr>
            </tbody>
          </table>
        </div>

        <p className="font-medium mt-4 mb-2">2) 재화/서비스 제공 및 민원 사무 처리</p>
        <div className="overflow-x-auto mt-2">
          <table className="w-full text-sm border-collapse border border-border">
            <thead>
              <tr className="bg-muted">
            ...
            <tbody>
              <tr><td className="border border-border px-3 py-2">디파이너리 (DFINERY)</td><td className="border border-border px-3 py-2">(필수) 성명, 회사 이메일, 회사명, 서비스명 (선택) 연락처</td><td className="border border-border px-3 py-2" rowSpan={4}>회원탈퇴 또는 서비스 이용계약 종료 시까지</td></tr>
              <tr><td className="border border-border px-3 py-2">모바일인덱스 (MOBILEINDEX)</td><td className="border border-border px-3 py-2">(필수) 성명, 이메일, 전화번호, 닉네임</td></tr>
              <tr><td className="border border-border px-3 py-2">트레이딩웍스 (TRADINGWORKS)</td><td className="border border-border px-3 py-2">(필수) 성명, 이메일, 전화번호, 회사명 또는 팀명 (선택) 직책</td></tr>
              <tr><td className="border border-border px-3 py-2">마케팅클라우드 (MARKETING CLOUD)</td><td className="border border-border px-3 py-2">(필수) 성명, 이메일, 회사명 또는 팀명 (선택) 직책</td></tr>
            </tbody>
          </table>
        </div>

        <p className="font-medium mt-4 mb-2">3) 요금 정산 처리</p>
        <div className="overflow-x-auto mt-2">
          <table className="w-full text-sm border-collapse border border-border">
            <thead>
              <tr className="bg-muted">
                <th className="border border-border px-3 py-2 text-left" colSpan={2}>구분</th>
                <th className="border border-border px-3 py-2 text-left">수집항목</th>
                <th className="border border-border px-3 py-2 text-left">보유기간</th>
              </tr>
            </thead>
            <tbody>
              <tr><td className="border border-border px-3 py-2" colSpan={2}>카드결제</td><td className="border border-border px-3 py-2">성명, 연락처</td><td className="border border-border px-3 py-2" rowSpan={3}>회원 탈퇴 또는 서비스 이용 계약 종료 시까지</td></tr>
              <tr><td className="border border-border px-3 py-2" rowSpan={2}>현금 결제</td><td className="border border-border px-3 py-2">법인</td><td className="border border-border px-3 py-2">사업자등록증, 사업자명, 담당자명, 연락처, 회사주소, 이메일</td></tr>
        ...
        <p className="font-medium mt-4 mb-2">4) 서비스 활용 데이터</p>
        <p className="text-body2 mb-2">아이지에이웍스는 디파이너리 서비스 제공과 관련하여 디파이너리 회원사가 이용자의 모바일 디바이스로부터 수집하거나 회원사를 통해 제공받는 서비스 활용 데이터를 아이지에이웍스가 정한 방침에 따라 처리하고 보유합니다. 단, 서비스 활용 데이터의 처리에 관하여 아이지에이웍스와 회원사가 그 처리 방식 및 절차, 기준 등을 별도 서면으로 정한 경우에는 그러한 내용이 본 개인정보처리방침 보다 우선하여 적용될 수 있습니다.</p>
        <div className="overflow-x-auto mt-2">
          <table className="w-full text-sm border-collapse border border-border">
            <thead>
              <tr className="bg-muted">
            ...
            <tbody>
              <tr><td className="border border-border px-3 py-2">디파이너리 (DFINERY)</td><td className="border border-border px-3 py-2">아래 항목을 포함하되 이에 국한되지 않습니다 광고식별값(ADID, IDFA), 플랫폼 정보(Android, iOS), 어트리뷰션 시 &quot;광고 매체 파트너&quot; 정보, IP주소, 이용 네트워크(3G, wifi), 디바이스 모델명/제조사명/해상도, 디바이스 통신사명, 디바이스 설정 언어/국가, 마켓 인스톨러 데이터</td><td className="border border-border px-3 py-2">서비스 이용계약 종료 후 30일까지</td></tr>
            </tbody>
          </table>
        </div>

        <p className="font-medium mt-4 mb-2">5) 맞춤 콘텐츠 / 마케팅 / 광고에의 활용</p>
        <p className="text-body2">IP주소, 쿠키, 방문접속기록, 서비스 이용기록, 구매 및 결제기록, 불량 이용기록, 기기정보의 행태정보는 서비스 이용 시 자동으로 생성되어 수집되는 개인정보로 아이지에이웍스는 정보주체의 동의 철회 또는 회원 탈퇴 시까지 해당 개인정보를 보유합니다.</p>
      </li>
      <li>
    ...
    <p className="text-body2 mb-4">아이지에이웍스는 정보주체의 개인정보를 처리 목적으로 명시한 범위를 초과하여 제3자에게 제공하지 않습니다. 다만, 아이지에이웍스는 「개인정보 보호법」, 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」, 「통신비밀보호법」, 「전기통신사업법」, 「전자상거래 등에서의 소비자보호에 관한 법률」, 「국세기본법」 등 다른 법령에 특별한 규정이 있는 경우 또는 재난, 감염병 등 긴급상황 발생 시 법률에서 규정한 적법한 절차에 따라 정보주체의 개인정보를 동의 없이 제공할 수 있습니다. 이 경우 근거법령에 의거하여 최소한의 개인정보만을 제공하고, 목적과 다르게 제공하지 않습니다.</p>
    <div className="overflow-x-auto mt-3">
      <table className="w-full text-sm border-collapse border border-border">
        <thead>
          <tr className="bg-muted">
            <th className="border border-border px-3 py-2 text-left">제공받는 자</th>
            <th className="border border-border px-3 py-2 text-left">제공 목적</th>
            <th className="border border-border px-3 py-2 text-left">제공 항목</th>
            <th className="border border-border px-3 py-2 text-left">보유 및 이용기간</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            ...
            <td className="border border-border px-3 py-2">- 스팸 신고된 고객명<br/>- 주민등록번호<br/>- 사업자등록번호<br/>- 전화번호</td>
      ...
      <li>
        ...
        <div className="overflow-x-auto mt-3">
          <table className="w-full text-sm border-collapse border border-border">
            <thead>
              <tr className="bg-muted">
                <th className="border border-border px-3 py-2 text-left">위탁업무</th>
                <th className="border border-border px-3 py-2 text-left">수탁기관 및 연락처</th>
                <th className="border border-border px-3 py-2 text-left">보유 및 이용기간</th>
              </tr>
            </thead>
            <tbody>
              <tr><td className="border border-border px-3 py-2">데이터 보관 / 전산시스템 운용, 관리</td><td className="border border-border px-3 py-2">- 업체명 : Amazon Web Service<br/>- 연락처 : aws-korea-privacy@amazon.com</td><td className="border border-border px-3 py-2" rowSpan={7}>위탁 사업 종료 또는 위탁업무 목적 달성 시까지</td></tr>
    ...
    <p className="text-body2">아이지에이웍스는 재화 또는 서비스 제공을 위하여 위탁받은 개인정보의 처리 업무의 전부 또는 일부를 제4조에 명시된 수탁기관 및 제3자에게 재위탁 할 수 있으며, 이 경우 아이지에이웍스는 위탁자로부터 사전 동의를 받습니다.</p>

    <h2 className="text-heading3 mt-12 mb-4">제5조 (개인정보의 국외 이전)</h2>
    <p className="text-body2 mb-4">아이지에이웍스는 정보주체의 개인정보를 국외의 다른 사업자에게 제공하지 않습니다. 다만, 정보통신서비스의 제공에 관한 계약 이행 및 이용자 편의 증진 등을 위하여 클라우드 서버를 사용함에 따라 다음과 같이 개인정보 처리업무를 국외에 전송하고 있습니다.</p>
    <div className="overflow-x-auto mt-3">
      <table className="w-full text-sm border-collapse border border-border">
        <tbody>
    ...
    <ol className="list-decimal pl-5 space-y-3 text-body2">
      ...
      <li>
        ...
        <ul className="list-disc pl-5 mt-2 space-y-1">
          ...
          <li>마) 전산실 및 자료보관실 등을 통제구역으로 설정하여 출입을 통제합니다.</li>
          <li>바) 아이지에이웍스는 정보주체의 아이디(ID), 비밀번호 도용을 방지하기 위하여 아이지에이웍스의 웹사이트에 연속으로 1년 이상 접속한 이력이 없을 경우 &apos;휴면 아이디(ID)&apos;로 정하여 「고객 본인확인 절차를 수행한 후 비밀번호를 신규 등록하도록」 로그인을 제한할 수 있습니다. 이 경우 아이지에이웍스는 &apos;휴면 아이디(ID)&apos; 전환 30일 전까지 정보주체에게 개인정보가 별도 분리되는 사실 및 휴면 예정일 등을 정보주체에게 통지합니다.</li>
          <li>사) 아이지에이웍스는 &apos;휴면 아이디(ID)&apos; 개인정보를 별도로 분리하여 보관하여야 하고, 분리 보관된 개인정보는 1년 간 보관 후 복구할 수 없는 방법으로 파기합니다.</li>
          <li>아) 아이지에이웍스는 3개월 단위로 비밀번호를 재설정 하도록 조치할 수 있고, 정보주체는 해당 기간 단위로 비밀번호를 재설정할 수 있습니다.</li>
        </ul>
      </li>
      <li>
        물리적 조치
        <ul className="list-disc pl-5 mt-2 space-y-1">
          <li>가) 전산실 및 자료보관실 등을 통제구역으로 설정하여 출입을 통제합니다.</li>
        </ul>
      </li>
    </ol>
    ...
    <ol className="list-decimal pl-5 space-y-3 text-body2">
      <li>
        ...
        <ul className="list-disc pl-5 mt-2 space-y-1">
          <li>가) 쿠키의 사용 목적 : 회원과 비회원의 접속 빈도나 방문 시간 등을 분석, 이용자의 취향과 관심분야를 파악 및 자취 추적, 각종 이벤트 참여 정도 및 방문 횟수 파악 등을 통한 타겟 마케팅 및 개인 맞춤 서비스 제공 목적으로 사용됩니다.</li>
        ...
        <div className="overflow-x-auto mt-3">
          <table className="w-full text-sm border-collapse border border-border">
            ...
            <tbody>
              ...
              <tr><td className="border border-border px-3 py-2" rowSpan={3}>분야별 개인정보보호책임자</td><td className="border border-border px-3 py-2">MI &amp; DMP &amp; 마케팅클라우드</td><td className="border border-border px-3 py-2">이철환</td><td className="border border-border px-3 py-2">hwan@igaworks.com</td></tr>
              <tr><td className="border border-border px-3 py-2" rowSpan={2}>디파이너리</td><td className="border border-border px-3 py-2">박진우</td><td className="border border-border px-3 py-2">mark@igaworks.com</td></tr>
              ...
              <tr><td className="border border-border px-3 py-2" rowSpan={2}>분야별 개인정보보호담당자</td><td className="border border-border px-3 py-2">MI &amp; DMP &amp; 마케팅클라우드</td><td className="border border-border px-3 py-2">성석주</td><td className="border border-border px-3 py-2">jeddy@igaworks.com</td></tr>
              <tr><td className="border border-border px-3 py-2">디파이너리</td><td className="border border-border px-3 py-2">이지원</td><td className="border border-border px-3 py-2">fynn.lee@igaworks.com</td></tr>
            </tbody>
          </table>
        </div>
      </li>
    ...
    <h2 className="text-heading3 mt-12 mb-4">제12조 (정보주체와 법정대리인의 권리ㆍ의무 및 행사방법)</h2>
    <ol className="list-decimal pl-5 space-y-3 text-body2">
      <li>
    ...
    <p className="text-body2">이 개인정보 처리방침은 2024년 11월 15일부터 적용됩니다. 이 전의 개인정보 처리방침은 아래에서 확인할 수 있습니다.</p>

    <h2 className="text-heading3 mt-12 mb-4">부칙</h2>
    <p className="text-body2 mb-2">본 개인정보처리방침은 2024년 11월 15일부터 시행합니다.</p>
