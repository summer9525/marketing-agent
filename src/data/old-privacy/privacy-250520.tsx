export const Privacy250520 = () => (
  <>
    ...
    <p className="text-body2 mb-6">본 개인정보처리방침은 2025년 5월 21일부터 적용됩니다.</p>
      ...
      <li>
        ...
        <div className="overflow-x-auto mt-2">
          <table className="w-full text-sm border-collapse border border-border">
            ...
            <tbody>
              <tr><td className="border border-border px-3 py-2">디파이너리 (DFINERY) &amp; 애드브릭스 (adbrix)</td><td className="border border-border px-3 py-2">(필수) 성명, 이메일</td><td className="border border-border px-3 py-2" rowSpan={2}>회원탈퇴 또는 서비스 이용계약 종료 시까지</td></tr>
        ...
        <div className="overflow-x-auto mt-2">
          <table className="w-full text-sm border-collapse border border-border">
            ...
            <tbody>
              <tr><td className="border border-border px-3 py-2">디파이너리 (DFINERY) &amp; 애드브릭스 (adbrix)</td><td className="border border-border px-3 py-2">(필수) 성명, 회사 이메일, 회사명, 서비스명 (선택) 연락처</td><td className="border border-border px-3 py-2" rowSpan={4}>회원탈퇴 또는 서비스 이용계약 종료 시까지</td></tr>
      ...
      <li>
        ...
        <div className="overflow-x-auto mt-3">
          <table className="w-full text-sm border-collapse border border-border">
            ...
            <tbody>
              <tr><td className="border border-border px-3 py-2">총괄 개인정보보호책임자</td><td className="border border-border px-3 py-2">기술이사</td><td className="border border-border px-3 py-2">박진우</td><td className="border border-border px-3 py-2">mark@igaworks.com</td></tr>
              <tr><td className="border border-border px-3 py-2" rowSpan={2}>분야별 개인정보보호책임자</td><td className="border border-border px-3 py-2">MI &amp; DMP &amp; 마케팅클라우드</td><td className="border border-border px-3 py-2">이철환</td><td className="border border-border px-3 py-2">hwan@igaworks.com</td></tr>
              <tr><td className="border border-border px-3 py-2">디파이너리 &amp; 애드브릭스</td><td className="border border-border px-3 py-2">한진원</td><td className="border border-border px-3 py-2">mike@igaworks.com</td></tr>
              ...
              <tr><td className="border border-border px-3 py-2">디파이너리 &amp; 애드브릭스</td><td className="border border-border px-3 py-2">이지원</td><td className="border border-border px-3 py-2">fynn.lee@igaworks.com</td></tr>
            </tbody>
          </table>
        </div>
      </li>
    ...
    <p className="text-body2">이 개인정보 처리방침은 2025년 5월 21일부터 적용됩니다. 이 전의 개인정보 처리방침은 아래에서 확인할 수 있습니다.</p>

    <h2 className="text-heading3 mt-12 mb-4">부칙</h2>
    <p className="text-body2 mb-2">본 개인정보처리방침은 2025년 5월 21일부터 시행합니다.</p>
