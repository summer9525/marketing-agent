export const Dfinery210831 = () => (
  <>
    ...
    <ol className="list-decimal pl-5 space-y-2 text-body2 mb-6">
      <li>&apos;디파이너리&apos;라 함은 &apos;회사&apos;가 &apos;회원사&apos;에게 제공하는 모바일 어플리케이션 데이터 분석 기능, 데이터 활용 기능, 포스트백 기능, 광고 성과 측정 기능, 부정 트래픽 방지 기능 등 관련 제반 서비스를 의미합니다.</li>
      <li>&apos;디파이너리 SDK&apos;라 함은 &apos;디파이너리&apos;가&apos; &apos;회원사&apos;의 모바일 어플리케이션에서 기능할 수 있도록 제공되는 소프트웨어 개발 도구를 의미합니다.</li>
      <li>&apos;디파이너리 사이트&apos;라 함은 &apos;디파이너리&apos; 제공 및 이용을 위해 &apos;회사&apos;가 운영하는 웹사이트(console.dfinery.io, dfinery.io, help.dfinery.io)를 의미합니다.</li>
      <li>&apos;디파이너리 콘솔&apos;(console.dfinery.io)이라 함은 &apos;디파이너리&apos;를 제공 및 관리하는 사이트를 의미합니다.</li>
      <li>&apos;회원사&apos;라 함은 &apos;디파이너리 콘솔&apos;에 접속하여 본 약관에 따라 &apos;회사&apos;와 이용계약을 체결하고 &apos;디파이너리&apos;를 이용하는 모바일 어플리케이션을 소유하고 있는 주체를 의미합니다.</li>
      <li>&apos;계정&apos;이라 함은 &apos;디파이너리 콘솔&apos;에서 &apos;회원사&apos;의 모바일 어플리케이션이 소속 및 관리되는 단위를 의미합니다.</li>
      ...
      <li>&apos;관리자&apos;(admin)라 함은 &apos;디파이너리&apos; 이용계약을 신청, 체결, 해지할 수 있는 &apos;회원사&apos; 본인 또는 &apos;회원사&apos;를 대표 또는 대리하는 &apos;구성원&apos;으로서, &apos;계정&apos;을 직접 생성하거나 &apos;관리자&apos;로부터 &apos;계정&apos;에 &apos;관리자&apos; 역할로 초대된 &apos;구성원&apos;을 의미하며, &apos;디파이너리&apos;의 모든 관리 기능을 이용할 수 있고 &apos;구성원&apos;을 &apos;계정&apos;에 초대하여 정의된 역할을 부여할 수 있습니다.</li>
      <li>&apos;최종 이용자&apos;라 함은 &apos;회원사&apos;가 제공하는 모바일 어플리케이션을 모바일 기기(스마트폰, 태블릿PC 등)에 설치 및 실행하여 기능을 이용하는 개인 혹은 단체를 의미합니다.</li>
      <li>&apos;광고 매체 파트너사&apos;라 함은 &apos;디파이너리&apos;를 통하여 광고 성과를 측정할 수 있도록 허용하거나, &apos;디파이너리&apos;로부터 &apos;포스트백&apos; 데이터를 수신할 수 있도록 협의된 광고매체 운영 회사를 의미합니다.</li>
      <li>&apos;세일즈 파트너사&apos;라 함은 &apos;회사&apos;로부터 &apos;디파이너리&apos;에 대한 판매 및 재판매 권한을 위임 받아 수행할 수 있는 주체를 의미합니다.</li>
      <li>테크 파트너사&apos;라고 함은 &apos;디파이너리&apos;와 다른 서비스를 결합하여 제공할 수 있도록 &apos;회사&apos;로부터 허락을 받은 솔루션 개발사나 서비스 제공사를 의미합니다.</li>
    ...
    <ol className="list-decimal pl-5 space-y-2 text-body2 mb-6">
      <li>&apos;회사&apos;는 본 약관의 내용을 &apos;회원사&apos; 및 &apos;구성원&apos;이 명확하게 알 수 있도록 &apos;디파이너리 사이트&apos;에 게시합니다.</li>
      <li>&apos;회사&apos;는 약관의 규제에 관한 법률, 정보통신망 이용촉진 및 정보보호 등에 관한 법률 등 관련 법령을 위배하지 않는 범위에서 본 약관을 개정할 수 있습니다.</li>
      <li>&apos;회사&apos;가 본 약관을 개정하고자 할 경우에는 적용일자 및 개정사유를 명시하여 현행약관과 함께 제1항의 방식에 따라 그 개정약관의 적용일자 7일 전부터 적용일자 전까지 공지합니다. 다만, &apos;회원사&apos; 또는 &apos;구성원&apos;에게 불리하게 변경되거나 중요한 내용이 개정되는 경우에는 30일 전부터 공지를 진행함과 동시에 일정기간 &apos;회원사&apos; 또는 &apos;구성원&apos;이 가입시 등록한 전자우편주소, 로그인시 동의창 등 1개 이상의 수단을 통해 &apos;회원사&apos; 또는 &apos;구성원&apos;에게 명확하게 통지합니다.</li>
      <li>&apos;회사&apos;가 전항에 따라 개정약관을 공지 또는 통지하면서 &apos;회원사&apos; 또는 &apos;구성원&apos;에게 공지 기간 내에 거부의 의사표시를 하지 않으면 약관 개정에 동의한 것으로 본다는 의미를 명확하게 통지하였음에도 &apos;회원사&apos; 또는 &apos;구성원&apos;이 명시적으로 거부의 의사표시를 하지 아니하였을 경우에는 &apos;회원사&apos; 또는 &apos;구성원&apos;이 개정약관에 동의한 것으로 봅니다.</li>
      <li>&apos;회원사&apos; 또는 &apos;구성원&apos;이 개정약관의 적용에 동의하지 않는 경우 &apos;회사&apos;는 개정약관의 내용을 적용할 수 없으며, 이 경우 &apos;회원사&apos; 또는 &apos;구성원&apos;은 이용계약을 해지할 수 있습니다. 다만, 기존 약관을 적용할 수 없는 특별한 사정이 있는 경우에는 &apos;회사&apos;가 &apos;회원사&apos; 또는 &apos;구성원&apos;과의 이용계약을 해지할 수 있습니다.</li>
    </ol>
    ...
    <ol className="list-decimal pl-5 space-y-2 text-body2 mb-6">
      ...
      <li>&apos;회사&apos;는 &apos;이용 신청자&apos;의 신청에 대하여 &apos;디파이너리&apos; 이용을 승낙함을 원칙으로 합니다. 다만, &apos;회사&apos;는 아래 각 호에 해당하는 신청에 대하여는 승낙을 하지 않거나 사후에 이용계약을 해지할 수 있습니다.
        <ul className="list-disc pl-5 space-y-1 text-body2 mb-4 mt-2">
          <li>&apos;이용 신청자&apos;가 본 약관에 의하여 이전에 &apos;회원사&apos; 또는 &apos;구성원&apos;의 자격을 상실한 적이 있는 경우. 단, &apos;회사&apos;의 &apos;회원사&apos; 또는 &apos;구성원&apos; 재가입 승낙을 얻은 경우에는 예외로 함.</li>
          <li>&apos;회원사&apos; 또는 &apos;구성원&apos;이 이용 신청시 허위 정보를 입력하거나 &apos;회사&apos;가 요구한 정보를 기재하지 않은 경우</li>
      ...
      <li>&apos;디파이너리&apos;의 기능 중 일부는 본 약관과는 별도의 이용 약관 확인 및 동의를 &apos;디파이너리 콘솔&apos;에서 완료한 이후에 활성화 됩니다.</li>
    </ol>
    ...
    <p className="text-body2 mb-3">
      &apos;회사&apos;는 정본통신망 이용촉진 및 정보보호 등에 관한 법률 등 관련 법령이 정하는 바에 따라 &apos;이용자&apos;의 개인정보를 보호하기 위해 노력합니다.
    </p>
    ...
    <ol className="list-decimal pl-5 space-y-2 text-body2 mb-6">
      <li>&apos;회사&apos;가 &apos;회원사&apos;와 &apos;구성원&apos;에게 통지를 하는 경우 이 약관에 별도 규정이 없는 한 이용 신청 시 등록한 전자우편주소를 이용합니다.</li>
      <li>&apos;회사&apos;가 &apos;관리자&apos;에게 통지한 경우 이는 &apos;일반 구성원&apos;에게 통지한 것으로 봅니다.</li>
    ...
    <ol className="list-decimal pl-5 space-y-2 text-body2 mb-6">
      <li>&apos;회사&apos;는 관련 법령과 본 약관이 금지하거나 미풍양속에 반하는 행위를 하지 않으며, 계속적이고 안정적으로 &apos;디파이너리&apos;를 제공하기 위해 최선의 노력을 다합니다.</li>
    ...
    <ol className="list-decimal pl-5 space-y-2 text-body2 mb-6">
      <li>&apos;회원사&apos; 및 &apos;구성원&apos;은 아래 각 호의 행위를 하여서는 안됩니다.
        <ul className="list-disc pl-5 space-y-1 text-body2 mb-4 mt-2">
          <li>이용신청 시 허위내용의 등록</li>
          <li>타인의 정보도용</li>
          <li>&apos;회사&apos; 및 기타 제3자의 저작권 등 지적재산권 및 권리 일체에 대한 침해</li>
          <li>&apos;회사&apos; 및 기타 제3자의 명예를 손상시키거나 업무를 방해하는 행위</li>
          <li>&apos;회사&apos;의 동의 없이 영리 목적으로 &apos;디파이너리&apos;를 사용하는 행위</li>
    ...
    <ol className="list-decimal pl-5 space-y-2 text-body2 mb-6">
      ...
      <li>&apos;디파이너리&apos;의 제공기능, 이용방법, 이용금액 등에 대하여 변경이 있는 경우에는 변경사유와 내용을 그 변경 전에 &apos;디파이너리 사이트&apos;에 게시합니다.</li>
    ...
    <ol className="list-decimal pl-5 space-y-2 text-body2 mb-6">
      ...
      <li>필요한 경우 &apos;회원사&apos;는 전 항에서 수집되는 데이터의 수집, 이용, 제3자 제공, 제3자 위수탁 등에 대해 &apos;최종 이용자&apos;에게 고지하고 이에 대한 명시적 동의를 받아야 하며, 관련 법령 등에 따라 보안조치를 취하여야 합니다. 관련된 적절한 절차 내지 조치를 수행하지 않아 발생한 문제에 대하여 &apos;회사&apos;는 책임을 부담하지 않습니다.</li>
    </ol>

    {/* 제16조 */}
    <h3 className="text-[16px] font-medium mt-10 mb-3">제 16 조 (&apos;디파이너리&apos; 이용제한)</h3>
    <ol className="list-decimal pl-5 space-y-2 text-body2 mb-6">
      <li>&apos;회사&apos;는 &apos;회원사&apos; 혹은 &apos;구성원&apos;이 본 약관을 위반하거나 &apos;디파이너리&apos;의 정상적인 운영을 방해한 경우 &apos;디파이너리&apos; 이용을 제한할 수 있으며, &apos;회사&apos;는 이에 대해 별도로 보상하지 않습니다.</li>
      <li>&apos;회원사&apos;가 제공하는 모바일 어플리케이션이 다음 각 호에 해당하는 경우 &apos;회사&apos;는 &apos;디파이너리&apos; 이용을 제한할 수 있으며, 이에 대해 별도로 보상하지 않습니다.
        <ul className="list-disc pl-5 space-y-1 text-body2 mb-4 mt-2">
          <li>음란물, 폭력물, 도박, 사회적 공익 저해 등 사회 공공질서 및 미풍양속을 저해하는 콘텐츠 제공을 목적으로 하는 경우</li>
          <li>모바일 어플리케이션을 서비스하는 국가에서 불법으로 규정된 콘텐츠 혹은 기능을 제공하는 경우</li>
        </ul>
      </li>
      <li>&apos;회사&apos;는 &apos;회원사&apos;가 이용중인 &apos;광고 매체 파트너사&apos;의 광고 트래픽 중 일부 또는 전체 트래픽이 &apos;부정 트래픽&apos;으로 의심되는 구체적인 상황을 발견했을 경우, 광고성과 측정 왜곡과 &apos;회원사&apos;의 과도한 비용 발생을 방지 등을 목적으로 사전 통지 없이 해당 일부 또는 전체 트래픽의 광고성과 측정 기능을 일시적으로 중단할 수 있습니다.</li>
      <li>&apos;유료 플랜&apos;을 이용중인 &apos;회원사&apos;가 1개월 기간의 이용 요금(연체기간이 이어서 1개월인 경우 및 연체 요금 합산액이 1개월분 요금인 경우 포함)을 결제하지 않을 경우, &apos;회사&apos;는 별도의 통지없이 &apos;유료 플랜&apos; 이용을 제한할 수 있습니다.</li>
    </ol>

    {/* 제17조 */}
    <h3 className="text-[16px] font-medium mt-10 mb-3">제 17 조 (&apos;디파이너리&apos; 이용 지원)</h3>
    <ol className="list-decimal pl-5 space-y-2 text-body2 mb-6">
      <li>&apos;회원사&apos; 혹은 &apos;구성원&apos;이 &apos;디파이너리&apos; 기능 이용 혹은 &apos;디파이너리 SDK&apos; 적용과 관련하여 전자우편, 유선, 구두 전달 등의 방법으로 지원을 요청했을 경우, &apos;회사&apos;의 담당자들은 요청받은 사항을 지원하기 위해 &apos;회원사&apos;의 모바일 어플리케이션 정보가 등록된 &apos;디파이너리 콘솔&apos; 혹은 &apos;회원사&apos;의 모바일 어플리케이션 빌드 파일에 접근할 수 있는 권리를 &apos;회원사&apos;로부터 부여 받은 것으로 간주합니다.</li>
      <li>&apos;회사&apos;는 &apos;회사&apos;가 제공하는 서비스의 개선과 신규 기능 제공, &apos;회원사&apos; 대상 통계 데이터 제공을 목적으로 &apos;디파이너리 SDK&apos; 및 &apos;회원사&apos;의 &apos;디파이너리 SDK&apos; 이용 과정에서 수집되는 데이터 중 &apos;최종 이용자&apos;의 모바일 디바이스 및 &apos;회원사&apos;의 모바일 어플리케이션을 특정할 수 없도록 처리된 자료를 수집, 가공, 이용할 수 있습니다.</li>
    </ol>

    {/* 제18조 */}
    <h3 className="text-[16px] font-medium mt-10 mb-3">제 18 조 (책임제한)</h3>
    <ol className="list-decimal pl-5 space-y-2 text-body2 mb-6">
      <li>&apos;회사&apos;는 천재지변 또는 이에 준하는 불가항력으로 인하여 &apos;디파이너리&apos;를 제공할 수 없는 경우에는 &apos;디파이너리&apos; 제공에 관한 책임이 면제됩니다.</li>
      <li>&apos;회사&apos;는, &apos;회원사&apos; 또는 &apos;구성원&apos;과 제3자간에 &apos;디파이너리&apos;를 매개로 이루어진 거래 등에 관하여는 책임을 지지 않습니다.</li>
      <li>&apos;회사&apos;는 &apos;무료 플랜&apos; 또는 무료로 제공되는 &apos;디파이너리&apos; 기능 이용과 관련하여 보상 또는 배상 책임을 지지 않습니다.</li>
      ...
      <li>&apos;포스트백&apos; 데이터의 최종 수신 주체가 &apos;광고 매체 파트너사&apos;, &apos;세일즈 파트너사&apos;, &apos;테크 파트너사&apos; 혹은 &apos;회원사&apos;(관리자, 일반구성원 포함)가 직접 정의한 제3의 업체 혹은 특정 저장소일 경우, &apos;포스트백&apos;을 수신한 주체가 데이터를 수집, 가공, 처리, 이용하는 방식과 의도와 관련하여 &apos;회원사&apos;와 최종 &apos;포스트백&apos; 수신 주체 간 문제에 대해 &apos;회사&apos;는 책임을 부담하지 않습니다.</li>
    ...
    <ol className="list-decimal pl-5 space-y-2 text-body2 mb-6">
      <li>&apos;회원사&apos;는 &apos;디파이너리 콘솔&apos; 또는 &apos;회사&apos;에 직접 연락하여 &apos;유료 플랜&apos; 가입을 신청할 수 있습니다. &apos;유료 플랜&apos;에 대한 정의와 구성 등 내용은 본 약관에 규정된 내용 외에는 &apos;디파이너리 사이트&apos;에 게시된 내용 또는 &apos;회사&apos;와 별도 합의한 내용에 따르며, 본 약관에 규정된 내용과 &apos;디파이너리 사이트&apos;에 게시된 내용 또는 &apos;회사&apos;와 별도 합의한 내용이 다른 경우, &apos;디파이너리 사이트&apos;에 게시된 내용 또는 &apos;회사&apos;와 별도 합의한 내용이 우선합니다.</li>
      ...
      <li>&apos;유료 플랜&apos; 신청 및 과금 단위는 &apos;계정&apos;에 등록된 모바일 어플리케이션 한 개 당 입니다.</li>
      ...
      <li>&apos;유료 플랜&apos; 이용을 해지할 경우 &apos;무료 플랜&apos;으로 전환됩니다. &apos;무료 플랜&apos;은 일부 기능에 제한이 있으며, &apos;무료 플랜&apos;으로 전환된 후 &apos;회원사&apos; 및 &apos;구성원&apos;은 제한이 발생하는 기능과 그 기능을 구성하는 원천 데이터에 접근할 수 없습니다. 필요할 경우 &apos;회원사&apos; 및 &apos;구성원&apos;은 이용해지 전 필요한 데이터를 스스로 백업해야 하며, 백업하지 않아 발생한 문제에 대해 &apos;회사&apos;는 책임을 부담하지 않습니다.</li>
    </ol>

    {/* 제20조 */}
    <h3 className="text-[16px] font-medium mt-10 mb-3">제 20 조 (&apos;디파이너리&apos; 중단 시 보상 등)</h3>
    <ol className="list-decimal pl-5 space-y-2 text-body2 mb-6">
      <li>&apos;회원사&apos;는 &apos;유료 플랜&apos; 이용 시 &apos;디파이너리&apos;가 중단되었을 때 적용되는 보상과 관련하여 다음 각 호를 참고할 수 있습니다.
        <ul className="list-disc pl-5 space-y-1 text-body2 mb-4 mt-2">
          <li>&apos;회사&apos;는 &apos;디파이너리&apos;의 월간 가동 시간 비율[해당월의 총 시간(분)에서 해당월에 발생한 중단시간(분)을 뺀 후 해당 월의 총 시간(분)으로 나눈 값, 이하 동일]을 매월 99.5%로 유지합니다.</li>
          <li>월간 가동 시간 비율 계산 시 &apos;beta&apos;가 표시된 기능은 중단 시 보상 또는 배상 청구를 할 수 없습니다.</li>
          <li>월간 가동 시간 비율 계산 시 단순 &apos;디파이너리 콘솔&apos; 접속 오류는 보상 또는 배상 청구를 할 수 없습니다.</li>
          <li>&apos;회사&apos;가 월간 가동 시간 비율을 99.5% 제공하지 못하였을 경우, &apos;회원사&apos;는 아래에 명시된 기준에 따라 보상서비스를 받을 수 있습니다. &apos;회사&apos;는 보상서비스에 해당하는 금액을 보상 관련 합의일의 익월에 &apos;회원사&apos;에게 제공합니다. 단, 매 1개월 기준 보상 금액은 월 이용 금액의 25%를 초과할 수 없습니다.99% 이상 ~ 99.5% 미만 : 중단이 발생한 월 이용 금액의 5%95% 이상 ~ 99% 미만 : 중단이 발생한 월 이용 금액의 15%95% 이하 : 중단이 발생한 월 이용 금액의 25%</li>
        </ul>
      </li>
      <li>본 약관 제18조에 명시된 이유에 의해 발생하거나, &apos;회원사&apos;가 소유 또는 관리하는 장비의 장애(&apos;회사&apos;의 주요 통제범위에 속하지 않는 문제)로 인해 발생하는 &apos;디파이너리&apos; 중단에 대해서는 본 조의 보상이 적용되지 않습니다.</li>
      <li>본 조에 따른 보상의 지급은 &apos;회원사&apos;가 &apos;디파이너리&apos; 중단이 발생한 시점에서 30일 이내에 청구사유, 청구금액 및 산출근거를 기재하여 &apos;디파이너리 사이트&apos;내 접수처를 통해 청구해야 하며, 이를 이행하지 않은 경우 &apos;회원사&apos;는 위와 같은 보상을 받을 권리를 상실하게 됩니다.</li>
      <li>본 조에 따른 보상의 지급은 &apos;유료 플랜&apos;을 이용하는 &apos;회원사&apos;에 한하여 적용됩니다.</li>
    </ol>
